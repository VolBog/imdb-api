...
public class IMDBITTest {
    ...
    public void testFetch() throws IMDBException {
        ...
        assertEquals(Arrays.asList("Quentin Tarantino"), movieDetails.getDirectors());
    ...
    public void testFetchAlternative() throws IMDBException {
        ...
        assertEquals(Arrays.asList("Ethan Coen", "Joel Coen"), movieDetails.getDirectors());
        assertEquals(Arrays.asList("Joel Coen", "Ethan Coen", "Cormac McCarthy"), movieDetails.getWriters());
        assertEquals(52, movieDetails.getStars().size());
        assertTrue(movieDetails.getStars().contains("Tommy Lee Jones"));
        assertEquals(Arrays.asList("Crime", "Drama", "Thriller"), movieDetails.getCategories());
    }
    ...
    public void testFetchAlternative2() throws IMDBException {
        ...
        assertEquals(Arrays.asList("Denis Villeneuve"), movieDetails.getDirectors());
        assertEquals(Arrays.asList("Aaron Guzikowski"), movieDetails.getWriters());
    ...
    public void testFetchTvEpisodeInformation() throws IMDBException {
        ...
        assertEquals(Arrays.asList("Talk-Show"), tvEpisodeDetails.getGenres());
    }
    ...
    public void testFetchTvEpisodeInformation2() throws IMDBException {
        ...
        assertEquals(Arrays.asList("Action", "Drama", "Adventure"), tvEpisodeDetails.getGenres());
    }
    ...
    public void testFetchTvShowInformation() throws IMDBException {
        ...
        assertEquals(genres, tvShowDetails.getGenres());
